...
exports.antdThemeConfig = exports.themeConfig = void 0;
const colorScheme = {
    colorPrimary: "#06ad99",
    colorWarning: "#DE8540",
    colorInfo: "#06ad99",
...
const antdThemeConfig = (theme) => {
    return {
        theme: Object.assign({ token: Object.assign(Object.assign({}, colorScheme), exports.themeConfig), components: {
                Alert: {
                ...
                Modal: {
                    ...
                    boxShadow: "2px 5px 12px 0px #0000001A,  9px 21px 22px 0px #00000017,19px 46px 30px 0px #0000000D,34px 82px 36px 0px #00000003,53px 128px 39px 0px #00000000",
                },
            } }, theme),
    };
};
exports.antdThemeConfig = antdThemeConfig;
